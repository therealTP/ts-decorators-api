...
import { CreateNewsSource } from './../models/NewsSource';
...
export class NewsSourceController {
    ...
    @Post("/")
    async post(@BodyParams() source: CreateNewsSource): Promise<string> {
        console.log("INST", source instanceof CreateNewsSource, source);
